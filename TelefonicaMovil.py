...
def getTipoServicioFija(texto):
    ...
    palabras_clave = ["Telefonía", "Servicios de Internet", "Aplicaciones Digitales", "Telefonia Movil", "TELEFONIA MOVIL"]
...
def extraer_info_factura_fija(texto): 
    ...
    datos["empresa"]= "TELEFONICA MOVIL"
...
def procesar_Telefonica_Movil(pdf_path, barra_progreso, archivo_excel): #DEVUELVE TEXTO PLANO
